 ...
 context 'validations' do
  ...
  describe 'instance methods' do
    it '.qualified_bulk_discounts returns all bulk discounts that an invoice item qualifies for' do
      ...
      discount_1 = merchant.bulk_discounts.create!(quantity_threshold: 5, discount_percent: 10)
      discount_1a = merchant.bulk_discounts.create!(quantity_threshold: 2, discount_percent: 8)
      ...
      expect(invoice_item_1a.best_bulk_discount).to eq(discount_1)
      expect(invoice_item_1a.best_bulk_discount).to_not eq(discount_1a)
    end
  end
