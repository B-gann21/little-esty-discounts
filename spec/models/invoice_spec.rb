...
RSpec.describe Invoice do
  ...
  context 'discounted revenue methods' do
    before :each do
      ...
      @invoice_item_2a = @invoice_2.invoice_items.create!(item_id: @item_1.id, quantity: 3, unit_price: 400, status: 2)
      @invoice_item_2b = @invoice_2.invoice_items.create!(item_id: @item_2.id, quantity: 3, unit_price: 400, status: 2)
      @invoice_item_2c = @invoice_2.invoice_items.create!(item_id: @item_3.id, quantity: 3, unit_price: 400, status: 2)
    end
